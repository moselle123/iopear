...
def create_event():
	data = request.json
	try:
		Event.create(data["measurement"], data["condition"], data["threshold"], data["active"])
...
def update_event(event_id):
	data = request.json
	try:
		Event.update(event_id, data["measurement"], data["condition"], data["threshold"], data["active"])
